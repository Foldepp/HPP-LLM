...
- Modell-Modi:
  - `Praxis Sicher (lokal)`: lokales Modell fuer sensible Praxis-/Patienteninhalte
  - `Praxis Schnell (Cloud)`: guenstiges Cloud-Modell fuer unkritische Aufgaben
  - `Praxis Stark (Cloud)`: staerkeres Cloud-Modell fuer anspruchsvollere Aufgaben
  - `DeepSeek Test (Cloud)`: zusaetzlicher Provider-Test
